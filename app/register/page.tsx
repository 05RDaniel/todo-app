          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-300">
                Join Orbit Tasks and start organizing your work. Create your account
                in seconds and begin tracking your tasks right away.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <StatCard label="Users" value="500+" />
              <StatCard label="Tasks created" value="10k+" />
            </div>
          </div>
